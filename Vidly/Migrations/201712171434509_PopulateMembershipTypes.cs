namespace Vidly.Migrations
{
    ...
    public partial class PopulateMembershipTypes : DbMigration
    {
        public override void Up()
        {
            ...
            Sql("INSERT INTO MembershipTypes (Id, Name, SignUpFee, DurationInMonths, DiscountRate) VALUES (3, 'Quaterly', 90, 3, 10)");
            Sql("INSERT INTO MembershipTypes (Id, Name, SignUpFee, DurationInMonths, DiscountRate) VALUES (4, 'Yearly', 300, 12, 15)");
